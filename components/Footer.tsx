...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center h-auto min-h-[70px] p-4 text-center">
      ...
      <div className="md:hidden block w-full max-w-[270px] mx-auto mb-2.5 text-light-slate">
          ...
          {siteConfig.socialMedia.map(({ name, url }, i) => (
            <li key={i}>
              <a
                ...
                className="p-2.5 inline-block hover:text-green hover:-translate-y-1 transition-all duration-250"
              >
      ...
      {/* Credit */}
      <div className="text-light-slate font-mono text-xs leading-tight">
        <a
          href="https://github.com/thechanpreetsingh"
          target="_blank"
          rel="noopener noreferrer"
          className="p-2.5 inline-block hover:text-green transition-colors"
        >
          <div>Designed & Built by Chanpreet Singh</div>
        </a>
      </div>
    </footer>
  )
